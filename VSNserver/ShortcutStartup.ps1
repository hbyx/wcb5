...
if (-not (Test-Path variable:global:PSVersionTable) -or $PSVersionTable.PSVersion.Major -lt 3) {
  $host.UI.WriteErrorLine("ERROR: VisualSVN Server PowerShell module is not available because you have an outdated version of Windows PowerShell installed on this computer. The minimum required version is Windows PowerShell 3.0.")
  Exit
}
...
if ($PSVersionTable.PSVersion.Major -lt 4) {
  Write-Warning "Some features of VisualSVN Server PowerShell module will not be available because you have an outdated version of Windows PowerShell installed on this computer. Please consider upgrading your Windows PowerShell to version 4.0 or later. For further details please see https://www.visualsvn.com/go/4038"
}

# SIG # Begin signature block
# MIIaOQYJKoZIhvcNAQcCoIIaKjCCGiYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvOPNpELNMDZa55VtJ4awhyii
# cNugghVVMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU6O3TdqmaVXNbuqOnE6I9
# dCmEjVMwNAYKKwYBBAGCNwIBDDEmMCSgIoAgAFYAaQBzAHUAYQBsAFMAVgBOACAA
# UwBlAHIAdgBlAHIwDQYJKoZIhvcNAQEBBQAEggEAsbZtNRyw34w40vWt4LIXwCCo
# v6qmGylmVqz+oadisyBfFnHueRUcVBnVYBv6aPa47im3TdEkLZY+fQGVyX1nd+qD
# /lt2ERCDzJCPA6/zLEtQhAb5S3EboftbfiCqTfWFiD0omXpCvaBZnfpGr3UhbCzL
# sdUnBVXPsWdycYwPga9p17JueUDMF6Wh+Abes+WM6fcIAgGtzLrh298VihCKEDoN
# 3d6w3yBE4Vdv4bjwm7wq/fApI6rXJv2QifeZUyk+OOW0F/zVmAR4CFQRcn3F06/O
# 8EErjPhCZ0hM+3IZhliSbkIPGZbWqf04C++GxJuTnGMhQEWPdfVYehgghagxiKGC
...
# DQEJBTEPFw0yMDA0MjIwOTIzNDRaMCMGCSqGSIb3DQEJBDEWBBTDdC+TldgGyHX5
# lfkmRv8+3v2I1TANBgkqhkiG9w0BAQEFAASCAQAPEfdIj5XAx1KMsgQuXz3HYYzY
# 9vPhVBIDbknVb8PySEELmY0rqYF6gmWC4TzwdcTflDbahmOgntX62pnWsIwmQ8Pa
# mukxL+vIKF42lsra7tlLthxq3ZPAxYlwLAwHpGfrYXFVSIxLJid0F6twXKcy/Zz4
# zIYh/ziQT8vCKzE+cTQFyKYGXYlpb4RG3W/FR/6Ztjl56+YH6NqHRhGsrSLDM0MK
# K9we0IY7gCJhEcH7U0uWsoyZXbWbPiIiHYeGMdSDUkgfX2DYBlJ/YGtI5r86oUdl
# Ty1of5i6QBnxlG52Qdj90Z0bZKzgOAfQ6QOgSd1TUoIx9DdN3QxxI31cfL29
