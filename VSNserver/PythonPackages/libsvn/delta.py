...
def svn_txdelta2(*args):
  """
    svn_txdelta2(svn_stream_t source, svn_stream_t target, svn_boolean_t calculate_checksum, 
        apr_pool_t pool)
    """
...
def svn_txdelta_send_contents(*args):
  """
    svn_txdelta_send_contents(unsigned char contents, apr_size_t len, svn_txdelta_window_handler_t handler, 
        void handler_baton, 
...
def svn_txdelta_to_svndiff_stream(*args):
  """
    svn_txdelta_to_svndiff_stream(svn_txdelta_stream_t txstream, int svndiff_version, 
        int compression_level, apr_pool_t pool) -> svn_stream_t
    """
...
def svn_delta_path_driver2(*args):
  """
    svn_delta_path_driver2(svn_delta_editor_t editor, void edit_baton, apr_array_header_t paths, 
...
def svn_delta_editor_invoke_apply_textdelta_stream(*args):
  """
    svn_delta_editor_invoke_apply_textdelta_stream(svn_delta_editor_t _obj, struct svn_delta_editor_t editor, 
        void file_baton, char base_checksum, 
        svn_txdelta_stream_open_func_t open_func, void open_baton, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_txdelta_invoke_stream_open_func(*args):
  """
    svn_txdelta_invoke_stream_open_func(svn_txdelta_stream_open_func_t _obj, void baton, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
