...
def svn_fs_create2(*args):
  """
    svn_fs_create2(char path, apr_hash_t fs_config, apr_pool_t result_pool, 
...
def svn_fs_open2(*args):
  """
    svn_fs_open2(char path, apr_hash_t fs_config, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_upgrade2(*args):
  """
    svn_fs_upgrade2(char path, svn_fs_upgrade_notify_t notify_func, void notify_baton, 
...
def svn_fs_hotcopy3(*args):
  """
    svn_fs_hotcopy3(char src_path, char dest_path, svn_boolean_t clean, 
        svn_boolean_t incremental, svn_fs_hotcopy_notify_t notify_func, 
...
def svn_fs_hotcopy2(*args):
  """
    svn_fs_hotcopy2(char src_path, char dest_path, svn_boolean_t clean, 
...
def svn_fs_node_history2(*args):
  """
    svn_fs_node_history2(svn_fs_root_t root, char path, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_history_prev2(*args):
  """
    svn_fs_history_prev2(svn_fs_history_t history, svn_boolean_t cross_copies, 
...
def svn_fs_node_relation(*args):
  """
    svn_fs_node_relation(svn_fs_node_relation_t relation, svn_fs_root_t root_a, 
        char path_a, svn_fs_root_t root_b, char path_b, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_node_has_props(*args):
  """svn_fs_node_has_props(svn_fs_root_t root, char path, apr_pool_t scratch_pool) -> svn_error_t"""
...
def svn_fs_props_different(*args):
  """
    svn_fs_props_different(svn_fs_root_t root1, char path1, svn_fs_root_t root2, 
        char path2, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_dir_entries_ex(*args):
  """
    svn_fs_dir_entries_ex(svn_fs_root_t root, char path, svn_fs_id_t hint_id, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
  return _fs.svn_fs_dir_entries_ex(*args)

def svn_fs_dir_optimal_order(*args):
  """
    svn_fs_dir_optimal_order(svn_fs_root_t root, apr_hash_t entries, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_try_process_file_contents(*args):
  """
    svn_fs_try_process_file_contents(svn_fs_root_t root, char path, svn_fs_process_contents_func_t processor, 
...
def svn_fs_contents_different(*args):
  """
    svn_fs_contents_different(svn_fs_root_t root1, char path1, svn_fs_root_t root2, 
        char path2, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_revision_prop2(*args):
  """
    svn_fs_revision_prop2(svn_fs_t fs, svn_revnum_t rev, char propname, svn_boolean_t refresh, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_revision_proplist2(*args):
  """
    svn_fs_revision_proplist2(svn_fs_t fs, svn_revnum_t rev, svn_boolean_t refresh, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_lock_target_create(*args):
  """svn_fs_lock_target_create(char token, svn_revnum_t current_rev, apr_pool_t result_pool) -> svn_fs_lock_target_t"""
  return _fs.svn_fs_lock_target_create(*args)

def svn_fs_lock_target_set_token(*args):
  """svn_fs_lock_target_set_token(svn_fs_lock_target_t target, char token)"""
  return _fs.svn_fs_lock_target_set_token(*args)

def svn_fs_lock_many(*args):
  """
    svn_fs_lock_many(svn_fs_t fs, apr_hash_t lock_targets, char comment, 
        svn_boolean_t is_dav_comment, apr_time_t expiration_date, 
        svn_boolean_t steal_lock, svn_fs_lock_callback_t lock_callback, 
...
def svn_fs_unlock_many(*args):
  """
    svn_fs_unlock_many(svn_fs_t fs, apr_hash_t unlock_targets, svn_boolean_t break_lock, 
...
def svn_fs_verify(*args):
  """
    svn_fs_verify(char path, apr_hash_t fs_config, svn_revnum_t start, 
        svn_revnum_t end, svn_fs_progress_notify_func_t notify_func, 
        void notify_baton, svn_cancel_func_t cancel_func, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_ioctl(*args):
  """
    svn_fs_ioctl(svn_fs_t fs, svn_fs_ioctl_code_t ctlcode, void input, 
...
def svn_fs_info_dup(*args):
  """svn_fs_info_dup(void info, apr_pool_t result_pool, apr_pool_t scratch_pool) -> void"""
  return _fs.svn_fs_info_dup(*args)
SVN_FS_SETTINGS_FSFS_COMPRESSION_TYPE = _fs.SVN_FS_SETTINGS_FSFS_COMPRESSION_TYPE

def svn_fs_get_settings(*args):
  """svn_fs_get_settings(svn_fs_t fs, apr_pool_t pool) -> svn_error_t"""
  return _fs.svn_fs_get_settings(*args)
class svn_fs_t:
...
def svn_fs_invoke_upgrade_notify(*args):
  """
    svn_fs_invoke_upgrade_notify(svn_fs_upgrade_notify_t _obj, void baton, apr_uint64_t number, 
...
def svn_fs_invoke_progress_notify_func(*args):
  """
    svn_fs_invoke_progress_notify_func(svn_fs_progress_notify_func_t _obj, svn_revnum_t revision, 
...
def svn_fs_invoke_hotcopy_notify(*args):
  """
    svn_fs_invoke_hotcopy_notify(svn_fs_hotcopy_notify_t _obj, void baton, svn_revnum_t start_revision, 
...
def svn_fs_invoke_mergeinfo_receiver(*args):
  """
    svn_fs_invoke_mergeinfo_receiver(svn_fs_mergeinfo_receiver_t _obj, char path, svn_mergeinfo_t mergeinfo, 
        void baton, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_fs_invoke_process_contents_func(*args):
  """
    svn_fs_invoke_process_contents_func(svn_fs_process_contents_func_t _obj, unsigned char contents, 
        apr_size_t len, void baton, apr_pool_t scratch_pool) -> svn_error_t
    """
  return _fs.svn_fs_invoke_process_contents_func(*args)

def svn_fs_invoke_lock_callback(*args):
  """
    svn_fs_invoke_lock_callback(svn_fs_lock_callback_t _obj, void baton, char path, 
        svn_lock_t lock, svn_error_t fs_err, apr_pool_t scratch_pool) -> svn_error_t
    """
