...
def svn_stream_contents_checksum(*args):
  """
    svn_stream_contents_checksum(svn_stream_t stream, svn_checksum_kind_t kind, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_stream_supports_reset(*args):
  """svn_stream_supports_reset(svn_stream_t stream) -> svn_boolean_t"""
  return _core.svn_stream_supports_reset(*args)
...
def svn_io_write_atomic2(*args):
  """
    svn_io_write_atomic2(char final_path, void buf, apr_size_t nbytes, char copy_perms_path, 
...
def svn_io_file_rename2(*args):
  """
    svn_io_file_rename2(char from_path, char to_path, svn_boolean_t flush_to_disk, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_stream_invoke_readline_fn(*args):
  """
    svn_stream_invoke_readline_fn(svn_stream_readline_fn_t _obj, void baton, char eol, 
        apr_pool_t pool) -> svn_error_t
    """
...
svn_checksum__crc32 = _core.svn_checksum__crc32
...
def svn_checksum_ctx_reset(*args):
  """svn_checksum_ctx_reset(svn_checksum_ctx_t ctx) -> svn_error_t"""
  return _core.svn_checksum_ctx_reset(*args)
...
class svn_cache_config_t:
    ...
    def __init__(self): 
        """__init__(self) -> svn_cache_config_t"""
