...
def svn_ra_get_commit_editor3(*args):
  """
    svn_ra_get_commit_editor3(svn_ra_session_t session, apr_hash_t revprop_table, 
        svn_commit_callback2_t commit_callback, apr_hash_t lock_tokens, 
...
def svn_ra_get_commit_editor2(*args):
  """
    svn_ra_get_commit_editor2(svn_ra_session_t session, char log_msg, svn_commit_callback2_t commit_callback, 
...
def svn_ra_list(*args):
  """
    svn_ra_list(svn_ra_session_t session, char path, svn_revnum_t revision, 
        apr_array_header_t patterns, svn_depth_t depth, 
        apr_uint32_t dirent_fields, svn_ra_dirent_receiver_t receiver, 
        void receiver_baton, 
...
def svn_ra_do_update3(*args):
  """
    svn_ra_do_update3(svn_ra_session_t session, svn_revnum_t revision_to_update_to, 
        char update_target, svn_depth_t depth, 
        svn_boolean_t send_copyfrom_args, svn_boolean_t ignore_ancestry, 
        svn_delta_editor_t update_editor, 
        void update_baton, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_ra_do_switch3(*args):
  """
    svn_ra_do_switch3(svn_ra_session_t session, svn_revnum_t revision_to_switch_to, 
        char switch_target, svn_depth_t depth, 
        char switch_url, svn_boolean_t send_copyfrom_args, 
...
def svn_ra_get_inherited_props(*args):
  """
    svn_ra_get_inherited_props(svn_ra_session_t session, char path, svn_revnum_t revision, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_ra_invoke_get_wc_contents_func(*args):
  """
    svn_ra_invoke_get_wc_contents_func(svn_ra_get_wc_contents_func_t _obj, void baton, svn_checksum_t checksum, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_ra_invoke_check_tunnel_func(*args):
  """
    svn_ra_invoke_check_tunnel_func(svn_ra_check_tunnel_func_t _obj, void tunnel_baton, 
        char tunnel_name) -> svn_boolean_t
    """
  return _ra.svn_ra_invoke_check_tunnel_func(*args)

def svn_ra_invoke_close_tunnel_func(*args):
  """
    svn_ra_invoke_close_tunnel_func(svn_ra_close_tunnel_func_t _obj, void close_baton, 
        void tunnel_baton)
    """
...
def svn_ra_invoke_open_tunnel_func(*args):
  """
    svn_ra_invoke_open_tunnel_func(svn_ra_open_tunnel_func_t _obj, void tunnel_baton, 
        char tunnel_name, char user, char hostname, int port, 
